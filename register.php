...
move_uploaded_file($_FILES['proof']['tmp_name'],'user_proof/'. $_FILES["proof"]['name']);
...
$msg="This email or Contact Number already associated with another account";
    ...
    $query=mysqli_query($con, "insert into tbluser(FullName, MobileNumber, Email,  Password,user_proof) value('$fname', '$mobno', '$email', '$password','$user_proof' )");
    if ($query) {
		
    $msg="You have successfully registered";
	header("Location: http://localhost/payingguest/register_paypal.php");
  }
  else
    {
...
<p style="text-align: center;color: red;font-size: 15px">*(Membership Payment Rs250)*</p>
    ...
    echo $msg;
				...
				<div class="col-lg-12">
					<form class="row contact_form" action="" method="post" id="" name="signup" onsubmit="return checkpass();" enctype="multipart/form-data">
						<div class="col-md-12">
						...
						<!--<div class="form-group">
						<input type="file" class="form-control" alt = "Proof" name="proof" placeholder="proof" required="true">
						</div>-->
