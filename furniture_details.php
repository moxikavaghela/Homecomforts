...
$query=mysqli_query($con,"insert into tblbookfurniture(Userid,Pgid,CheckinDate,UserMsg,BookingNumber) values('$userid','$pid','$chkin','$msg','$booknumber') ");
if($query)
{
    ...
    <section class="blog_area single-post-area p_120">
        <div class="container">
            <div class="row mt-80">
                 <?php
 $cid=$_GET['pid'];
$ret=mysqli_query($con,"select * from firniture where fur_id='$cid'");
$cnt=1;
...
<h2 align="center" style="margin-top:2%"><?php echo $row['fur_name'];?>'s Details</h2>      
                        </div>
