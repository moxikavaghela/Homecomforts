<html lang="en">
<head>
    <title>HOME COMFORTS System Payment Gateway</title>
</head>
...
<div class="container text-center">
	<br/>
	<h2><strong>Paypal Payment Gateway Integration</strong></h2>
	<br/>
	<div class="row">
    			...
    			<form action="<?php echo $paypalUrl; ?>" method="post" name="frmPayPal1">
					<div class="panel price panel-red">
						...
						<div class="panel-body text-center">
							<p class="lead" style="font-size:40px"><strong>$3.33 / Year</strong></p>
						</div>
						...
						<div class="panel-footer">
							<button class="btn btn-lg btn-block btn-danger" href="#">Register as a User!</button>
						</div>
					</div>
    			</form>
			<!-- /PRICE ITEM -->
