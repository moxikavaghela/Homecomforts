		...
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-md-10 header-text">
					<h1>HOME COMFORTS Search Result</h1>
					<p>
...
$ret=mysqli_query($con,"select * from tblpg where CityName='$state' and PGTitle like '%$pgname%'");
$cnt=1;
				...
				<div class="col-lg-4">
					<div class="single-property">
						<div class="images">
							...
							<span>For Property</span>
						</div>

						<div class="desc">
							<div class="top d-flex justify-content-between">
								<h4><a href="pg-details.php?pid=<?php echo $row['ID'];?>">Property Name: <?php echo $row['PGTitle'];?></a></h4>
